  ...
  <div id="home">
    ...
    <div id="main-box">
      <div id="main-content">
        ...
        <p>
          第73回麻布学園文化祭は、2020年10月31日と11月1日の2日間にわたって開催されました。
        </p>
        <p>
          また、オンラインでの文化祭企画も、2020年10月31日～11月15日の間公開し、計
          7,506 人もの方々にご覧いただきました。<br />
          本当にありがとうございました！
        </p>
        <p>
          なお、特設ページ以外のページについては URL を変更し、73.afes.info
          にて引き続き公開しています。
        </p>
        <hr />
        <p>
